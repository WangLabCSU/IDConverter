...
#>     OK: 91743 rows
#>   Cached to: /tmp/Rtmpqed9np/grch38.rda
#> 
...
#> --- Building: grch38 ---
#>   Loading from cache: /tmp/Rtmpqed9np/grch38.rda
#> --- Building: grch37 ---
#>   Trying mirror: https://useast.ensembl.org
#>     Failed: HTTP 403 Forbidden.
#>   Trying mirror: https://uswest.ensembl.org
...
#>   Trying mirror: https://www.ensembl.org
#>     OK: 91743 rows
#>   Cached to: /tmp/Rtmpqed9np/grch37.rda
#> --- Building: grcm38 ---
#>   Trying mirror: https://useast.ensembl.org
#>     Failed: HTTP 403 Forbidden.
#>   Trying mirror: https://uswest.ensembl.org
...
#>   Trying mirror: https://www.ensembl.org
#>     OK: 78718 rows
#>   Cached to: /tmp/Rtmpqed9np/grcm38.rda
#> --- Building: rnor6 ---
#>   Trying mirror: https://useast.ensembl.org
#>     Failed: HTTP 403 Forbidden.
#>   Trying mirror: https://uswest.ensembl.org
...
#>   Trying mirror: https://www.ensembl.org
#>     OK: 57760 rows
#>   Cached to: /tmp/Rtmpqed9np/rnor6.rda
#> --- Building: bdgp6 ---
#>   Trying mirror: https://useast.ensembl.org
#>     Failed: HTTP 403 Forbidden.
#>   Trying mirror: https://uswest.ensembl.org
...
#>   Trying mirror: https://www.ensembl.org
#>     OK: 28759 rows
#>   Cached to: /tmp/Rtmpqed9np/bdgp6.rda
#> --- Building: galgal5 ---
#>   Trying mirror: https://useast.ensembl.org
#>     Failed: HTTP 403 Forbidden.
#>   Trying mirror: https://uswest.ensembl.org
...
#>   Trying mirror: https://www.ensembl.org
#>     OK: 34332 rows
#>   Cached to: /tmp/Rtmpqed9np/galgal5.rda
#> --- Building: mmul801 ---
#>   Trying mirror: https://useast.ensembl.org
#>     Failed: HTTP 403 Forbidden.
#>   Trying mirror: https://uswest.ensembl.org
...
#>   Trying mirror: https://www.ensembl.org
#>     OK: 37169 rows
#>   Cached to: /tmp/Rtmpqed9np/mmul801.rda
#> --- Building: wbcel235 ---
#>   Trying mirror: https://useast.ensembl.org
#>     Failed: HTTP 403 Forbidden.
#>   Trying mirror: https://uswest.ensembl.org
...
#>   Trying mirror: https://www.ensembl.org
#>     OK: 46926 rows
#>   Cached to: /tmp/Rtmpqed9np/wbcel235.rda
...
#>   Trying mirror: https://www.ensembl.org
#>     OK: 34012 rows
#>   Cached to: /tmp/Rtmpqed9np/cfamiliaris.rda
#> --- Building: drerio ---
#>   Trying mirror: https://useast.ensembl.org
#>     Failed: HTTP 403 Forbidden.
#>   Trying mirror: https://uswest.ensembl.org
...
#>   Trying mirror: https://www.ensembl.org
#>     OK: 92137 rows
#>   Cached to: /tmp/Rtmpqed9np/drerio.rda
#> --- Building: sscrofa ---
#>   Trying mirror: https://useast.ensembl.org
#>     Failed: HTTP 403 Forbidden.
#>   Trying mirror: https://uswest.ensembl.org
...
#>   Trying mirror: https://www.ensembl.org
#>     OK: 35819 rows
#>   Cached to: /tmp/Rtmpqed9np/sscrofa.rda
...
#>   Trying mirror: https://www.ensembl.org
#>     OK: 670670 rows
#>   Cached to: /tmp/Rtmpqed9np/grch38_tx2gene.rda
...
#>   Trying mirror: https://www.ensembl.org
#>     OK: 670670 rows
#>   Cached to: /tmp/Rtmpqed9np/grch37_tx2gene.rda
...
#>   Trying mirror: https://www.ensembl.org
#>     OK: 481956 rows
#>   Cached to: /tmp/Rtmpqed9np/grcm38_tx2gene.rda
...
#>   Trying mirror: https://www.ensembl.org
#>     OK: 95472 rows
#>   Cached to: /tmp/Rtmpqed9np/rnor6_tx2gene.rda
...
#>   Trying mirror: https://www.ensembl.org
#>     OK: 41600 rows
#>   Cached to: /tmp/Rtmpqed9np/bdgp6_tx2gene.rda
...
#>   Trying mirror: https://www.ensembl.org
#>     OK: 72689 rows
#>   Cached to: /tmp/Rtmpqed9np/galgal5_tx2gene.rda
...
#>   Trying mirror: https://www.ensembl.org
#>     OK: 64228 rows
#>   Cached to: /tmp/Rtmpqed9np/mmul801_tx2gene.rda
...
#>   Trying mirror: https://www.ensembl.org
#>     OK: 60000 rows
#>   Cached to: /tmp/Rtmpqed9np/wbcel235_tx2gene.rda
...
#>   Trying mirror: https://www.ensembl.org
#>     OK: 55335 rows
#>   Cached to: /tmp/Rtmpqed9np/cfamiliaris_tx2gene.rda
...
#>   Trying mirror: https://www.ensembl.org
#>     OK: 65905 rows
#>   Cached to: /tmp/Rtmpqed9np/drerio_tx2gene.rda
...
#>   Trying mirror: https://www.ensembl.org
#>     OK: 60440 rows
#>   Cached to: /tmp/Rtmpqed9np/sscrofa_tx2gene.rda
#> 
